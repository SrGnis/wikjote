...
def register_rules():
    ...
    ProcessorAssignator.add_rule(NameRule('Información adicional', ListProcessor, 'additional_info'))
    ProcessorAssignator.add_rule(NameRule('Véase también', ListProcessor, 'see_more'))
    ProcessorAssignator.add_rule(NameRule('Traducciones', TranslationsProcessor, 'translations'))
    ProcessorAssignator.add_rule(XPathRule(xpathqueries['language_section_rule'], LanguageProcessor, 'languaje'))
    ProcessorAssignator.add_rule(XPathRule(xpathqueries['sense_section_rule'], SensesProcessor, 'senses'))
